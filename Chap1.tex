...
% conﬁguration was ﬁrst identiﬁed by spectral energy distribution
% ﬁtting (Dong et al. 2012; Hashimoto et al. 2012), and later
% conﬁrmed by observations in the near-IR with SPHERE
...
% in the gap between these two disks, conﬁrmed by the 4σ
% detection of \ha emission at the location of the companion
% using MagAO narrow ﬁlters (Wagner et al. 2018). The
...
% integral-ﬁeld spectroscopy with the Very Large Telescope
